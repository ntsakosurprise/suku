	...
	*********************************************************************************************************************/
	...
	is_equal_node : function(n1,n2){
		...
		if(n1.nodeType === n2.nodeType ){
			 ...
			 if(n1 instanceof HTMLElement && n2 instanceof HTMLElement){
				 
				 
					if(n1.tagName === n2.tagName){
						
						
							 let n1Ats = this.get_element_attributes(n1)
							 let n2Ats = this.get_element_attributes(n2)


							 console.log('NODES')
							 console.log(n1)
							 console.log(n2)
							 console.log(n1Ats.length)
							 console.log(n2Ats.length)
							 console.log(n1Ats.hasOwnProperty('length'))
							 console.log(n2Ats.hasOwnProperty('length'))

							 console.log('Attributes')
							 console.log(n1Ats)
							 console.log(n2Ats)
							 
							 if(n1Ats.length === n2Ats.length ){

									console.log('THE CURRENT NODES ARE EQUAL')
									
									  if(n1Ats.length > 0 && n2Ats.length > 0){

										for(let a = 0; a < n1Ats.length; a++){

												console.log('The a value')
												console.log(a)
												console.log(n1Ats.length -1)
												console.log(n1Ats[a])
												console.log(n1Ats[a].nodeName === 'data-hydrate-event')
												
												if(n1Ats[a].nodeName.trim() === 'data-hydrate-event' && (a === n1Ats.length -1)){

													console.log('The current event is data-hydrate')
													if(n1.children.length === n2.children.length){
										
														// let n1Chs = n1.children
														// let n2Chs = n2.children 

														console.log('The nodes are the same, children length is the same')
														isEqual = true
														break
										
													}else{
														
														console.log('Nodes do not match by children length mismatch') 
														isEqual = false
														break 
													...
													if(n1Ats[a].nodeValue.trim() !== n2Ats[a].nodeValue.trim()){
													
														console.log('Attributes do not match by attribute value')
														isEqual = false
														break 
													}else if(a === n1Ats.length -1){
														...
														if(n1.children.length === n2.children.length){
															...
															console.log('The nodes are the same, children length is the same')
															// console.log('N1 child')
															// console.log(n1Chs)
															// console.log('N2 child')
															// console.log(n2Chs)
	
															// console.log('Innerhtml of the two elements')
	
															// if(n1.hasOwnProperty('innerHTML')){
																
															// 	let trimmed =  n1.innerHTML.trim()
															// 	console.log(trimmed === n2.innerHTML)
															// 	console.log('The element has innerHTML prop')
															// 	console.log(n2)
	
															// }else{
	
															// 	console.log('The element has no innerHtml')
															...
															// for(let c = 0; c < n1Chs.length; c++){
																
															// 	console.log('The return value')
															// 	console.log(this.is_equal_node(n1Chs[c],n2Chs[c]))
																
																
															// 	if(!this.is_equal_node(n1Chs[c],n2Chs[c])){
																	
															// 		console.log("One of the nodes children do not match")
															// 		console.log('N1 child')
															// 		console.log(n1Chs[c])
															// 		console.log('N2 child')
															// 		console.log(n2Chs[c])
										...
										console.log('THE TWO NODES ARE THE SAME, BUT THEY HAVE NO ATTRIBUTES')
										console.log(n1)
										console.log(n2) 
										isEqual = true
									...
									console.log('Nodes attriutes do not match')
									// console.log('N1 attributes')
									// console.log(n1Ats)
									// console.log(n1Ats.length)
									// console.log('N2 attributes')
									// console.log(n2Ats)
									// console.log(n2Ats.length)
									isEqual = false
						 ...
						 console.log('Nodes tags do not match')
						 isEqual = false
					...
					console.log('Node is not an an instanceof HTMLElement')
					isEqual = false
			...
			console.log('Nodes are not equal: NodeTypes do not match')
			isEqual = false
